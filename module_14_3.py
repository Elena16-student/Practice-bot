...
async def get_buying_list(message):
    ...
    products = [
        'Название: image_1 | Описание: описание 1 | Цена: 100',
        'Название: image_2 | Описание: описание 2 | Цена: 200',
        'Название: image_3 | Описание: описание 3 | Цена: 300',
        'Название: image_4| Описание: описание 4 | Цена: 400'
    ]
